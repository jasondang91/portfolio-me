...
const Divider: React.FC<DividerProps> = ({ direction, color, thickness, height, dividerStyle }) => {
	const borderStyle = {
	...
	return (
		<div style={directionStyle} className='relative'>
			<div className='mb-10 flex justify-end ' style={{ height: heightStyle?.heights[0], ...spaceStyle }}>
				<div
					className='h-full'
					style={{
						...borderStyle,
			...
			<div className='-mt-10 flex justify-end' style={{ height: heightStyle?.heights[1] }}>
				<div
					className='h-full'
					style={{
						...borderStyle,
